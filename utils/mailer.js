...
const resetPasswordMail = (to, collection, token) => {
    const msg = {
        to: to,
        ...
        text: "mametyna",
        html: `
            <h1>to reset your ${collection} password plese follow the link bellow</h1>
            <a href="http://localhost:3000/new-password/${collection}/${token}">reset password</a>
        `
    };
    sgMail.send(msg);
};
